import 'package:firstapp/registerasuser.dart';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                MainButtons(tittle: "REGISTER AS A USER", onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> const RegAsUser()),);
                      },),
                const SizedBox(
                  height: 30,
                ),
                MainButtons(tittle: "REGISTER AS A VENDOR", onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=> const VendorRegistration()),);
